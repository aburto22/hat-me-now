...
export default function Main() {
  return (
    <div className="max-w-4xl mx-auto bg-white border border-gray-light flex flex-col items-center">
      <div className="self-stretch border-b border-gray-light relative">
        <img
          src="/images/general/main-hat.jpg"
          alt="Woman with hat in swimming pool"
          className="w-full"
        />
        <div className="absolute bg-white bg-opacity-50 top-4 md:top-8 left-0 w-full py-4">
          <h1 className="text-xl text-center font-light">Welcome!</h1>
        </div>
      </div>
